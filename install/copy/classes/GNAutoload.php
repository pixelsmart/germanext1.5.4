...
class GNAutoload
{
	...
	protected function __construct() {
		...
		if (file_exists($this->root_dir.GNAutoload::INDEX_FILE)) {
			$this->index = include($this->root_dir.GNAutoload::INDEX_FILE);
		}
	}
	...
	public static function getInstance() {
		if ( ! GNAutoload::$instance) {
			GNAutoload::$instance = new GNAutoload();
		}

		return GNAutoload::$instance;
	}
	...
	public function generateIndex() {
		$classes = array_merge(
			...
			$this->getClassesFromDir('modules/germanext/gn_override/classes/'),
			$this->getClassesFromDir('controllers/'),
			$this->getClassesFromDir('override/controllers/'),
			$this->getClassesFromDir('modules/germanext/gn_override/controllers/')
		);
		ksort($classes);
		$content = '<?php return '.var_export($classes, true).'; ?>';

		// Write classes index on disc to cache it
		$filename = $this->root_dir.GNAutoload::INDEX_FILE;
