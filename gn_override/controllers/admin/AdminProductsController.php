...
class AdminProductsController extends AdminProductsControllerCore
{
	...
	public function postProcess()
	{
		...
		if (sizeof($this->js_files)) {
		    foreach ($this->js_files as $k => $v) {
			if (substr(strrchr($v, '/'), 1) == 'admin-products.js') {
			    unset($this->js_files[$k]);
		...
		$this->addJS(array(
		    GN_REL_PATH.'js/admin/AdminProductsController/admin-products.js',
		    GN_REL_PATH.'js/admin/AdminProductsController/attributesBack.js',
		));
	    }
	}
