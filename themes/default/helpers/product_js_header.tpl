...
// Translations
var doesntExist = '{l s='This combination does not exist for this product. Please select another combination.' mod='germanext' js=1}';
var doesntExistNoMore = '{l s='This product is no longer in stock' mod='germanext' js=1}';
var doesntExistNoMoreBut = '{l s='with those attributes but is available with others' mod='germanext' js=1}';
var uploading_in_progress = '{l s='Uploading in progress, please be patient.' mod='germanext' js=1}';
var fieldRequired = '{l s='Please fill in all the required fields before saving your customization.' mod='germanext' js=1}';
{if isset($groups)}
	// Combinations
