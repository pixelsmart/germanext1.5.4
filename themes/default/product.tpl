			...
			<div class="block products_block accessories_block clearfix">
				<div class="block_content">
					...
					{foreach from=$accessories item=accessory name=accessories_list}
						{if ($accessory.allow_oosp || (isset($accessory.quantity_all_versions) && $accessory.quantity_all_versions > 0)) AND $accessory.available_for_order AND !isset($restricted_country_mode)}
